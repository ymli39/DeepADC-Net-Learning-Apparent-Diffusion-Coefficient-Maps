...
class DWI_loader(Dataset):
        ...
        with open(data_list, 'r') as f:
            for line in f:
                ...
                for i in range(dim):
                    ...
                    self.adc_names.append(os.path.join(adc_dir, line.rstrip() + '_Diffusion_Fits_5b_noc.npy'))
                    self.down_adcs.append(os.path.join(adc_4x_dir, line.rstrip() + '_Diffusion_Fits_5b_noc.npy'))
    ...
    def __getitem__(self, idx):
        ...
        down_img_map =np.clip(down_img, 0, orig_b1_max)
        down_img_map = down_img_map/orig_b1_max
        ...
        orig_image_map = orig_image_map * mask
        down_img_map = down_img_map * mask
        orig_adc = orig_adc * mask
        down_adc = down_adc * mask
