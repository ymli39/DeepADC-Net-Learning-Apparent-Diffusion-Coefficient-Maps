...
class SpatialSELayer(nn.Module):
    ...
    def forward(self, input_tensor):
        ...
        return output_tensor, squeeze_tensor
...
class ChannelSpatialSELayer(nn.Module):
    ...
    def forward(self, input_tensor):
        ...
        :return: output_tensor
        """
        output_sSEtensor, squeeze_tensor = self.sSE(input_tensor)
        output_cSEtensor = self.cSE(input_tensor)
        output_tensor = torch.max(output_cSEtensor, output_sSEtensor)
#        output_tensor = torch.max(self.cSE(input_tensor), self.sSE(input_tensor))
        return output_tensor, output_cSEtensor
